    ...
    <div className="min-h-screen overflow-x-hidden bg-void noise-overlay">
      ...
      >
        <div className="mx-4 mt-4">
          <div className="mx-auto max-w-6xl rounded-2xl border border-neon-cyan/20 bg-void/80 backdrop-blur-xl px-6 py-3">
            <div className="flex items-center justify-between">
              <Link href="/" className="flex items-center gap-2.5">
                <div className="relative h-8 w-8 rounded-lg bg-neon-pink flex items-center justify-center neon-box-pink">
              ...
              <nav className="hidden md:flex items-center gap-8">
                <a href="#features" className="text-sm text-neon-cyan/50 hover:text-neon-cyan transition-colors relative group">
                  Features
                  <span className="absolute -bottom-1 left-0 w-0 h-px bg-neon-cyan group-hover:w-full transition-all duration-300" />
                </a>
                <a href="#how-it-works" className="text-sm text-neon-cyan/50 hover:text-neon-cyan transition-colors relative group">
                  How It Works
                  <span className="absolute -bottom-1 left-0 w-0 h-px bg-neon-cyan group-hover:w-full transition-all duration-300" />
                </a>
                <a href="#tech" className="text-sm text-neon-cyan/50 hover:text-neon-cyan transition-colors relative group">
                  Tech Stack
                  <span className="absolute -bottom-1 left-0 w-0 h-px bg-neon-cyan group-hover:w-full transition-all duration-300" />
                </a>
                <Link
                  href="/dashboard"
                  className="text-sm text-neon-cyan/50 hover:text-neon-cyan transition-colors relative group"
                >
                  Dashboard
                  <span className="absolute -bottom-1 left-0 w-0 h-px bg-neon-cyan group-hover:w-full transition-all duration-300" />
                </Link>
              ...
              <Link
                ...
                className="group relative inline-flex items-center justify-center rounded-xl text-sm font-medium border-2 border-neon-pink text-neon-pink px-5 py-2.5 overflow-hidden transition-all neon-box-pink hover:bg-neon-pink/10"
              >
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center pt-24 overflow-hidden">
        ...
        <div className="absolute inset-0 sunset-bg opacity-20" />
        ...
        {/* Retro sun */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 retro-sun opacity-20 scale-[0.6]" />
        ...
        {/* Wireframe shapes */}
        <div className="absolute top-[15%] left-[8%] opacity-20 wireframe-cube" />
        <div className="absolute bottom-[20%] right-[10%] opacity-15 wireframe-pyramid" />
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          >
            <Layers className="h-14 w-14 text-neon-yellow animate-flicker" strokeWidth={1} />
          </motion.div>
          <motion.div
          ...
          >
            <Terminal className="h-12 w-12 text-neon-pink" strokeWidth={1} />
          </motion.div>
        </div>
        ...
        >
          <div className="mx-auto max-w-4xl text-center">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 rounded-full border border-neon-cyan/30 bg-neon-cyan/5 backdrop-blur-sm px-5 py-2 mb-8"
            >
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-neon-cyan opacity-75" />
                <span className="relative inline-flex h-2 w-2 rounded-full bg-neon-cyan" />
              </span>
              <span className="text-[10px] font-medium text-neon-cyan font-pixel uppercase tracking-wider">
            ...
            >
              <span className="text-[10px] text-neon-purple/30 font-pixel">オートノマス・エージェント</span>
            </motion.div>
            ...
            >
              ...
              receive <span className="text-neon-pink font-medium neon-glow-pink">50% of protocol revenue</span> based on your Creator Score.
            </motion.p>
            ...
            >
              <Link
                href="/dashboard/deploy"
                className="group relative inline-flex items-center justify-center rounded-xl text-base font-semibold border-2 border-neon-pink bg-neon-pink/10 text-white px-8 py-4 overflow-hidden transition-all neon-box-pink hover:bg-neon-pink/20"
              >
              ...
              <Link
                href="/dashboard"
                className="group inline-flex items-center justify-center rounded-xl text-base font-medium border border-neon-cyan/30 text-neon-cyan px-8 py-4 hover:bg-neon-cyan/10 transition-all"
              >
                View Dashboard
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-neon-cyan/60">428+ creators earning</span>
              </div>
              <div className="h-4 w-px bg-neon-cyan/20" />
              <div className="flex items-center gap-1.5">
                <div className="h-2 w-2 rounded-full bg-neon-cyan animate-neon-pulse" />
                <span className="text-neon-cyan/60">1,247 agents live</span>
              </div>
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          <a href="#stats" className="flex flex-col items-center gap-2 text-neon-cyan/40 hover:text-neon-cyan transition-colors">
      ...
      {/* ─── Stats ──────────────────────────────── */}
      <section id="stats" className="relative py-24 border-y border-neon-cyan/10">
            ...
            {stats.map((stat, i) => (
              <ScaleInWhenVisible key={stat.label} delay={i * 0.1}>
                <div className="text-center group">
                  <div className="inline-flex items-center justify-center h-12 w-12 rounded-xl bg-neon-pink/10 border border-neon-pink/20 mb-4 mx-auto group-hover:border-neon-pink/40 transition-colors">
                    <stat.icon className="h-5 w-5 text-neon-pink group-hover:text-neon-pink transition-colors" />
                  </div>
                  <p className="text-4xl md:text-5xl font-bold font-orbitron">
                    <span className="text-neon-cyan neon-glow-cyan">{stat.value}</span>
                    {stat.suffix && (
              ...
              <FadeInWhenVisible key={feature.title} delay={i * 0.1}>
                <div className="group animated-border h-full">
                  <div className="retro-window h-full overflow-hidden">
                    ...
                    <div className="relative bg-void/80 backdrop-blur-sm p-8 md:p-10 h-full transition-all duration-500 group-hover:bg-void/90">
      ...
      {/* ─── How It Works ───────────────────────── */}
      <section id="how-it-works" className="relative py-32 border-y border-neon-cyan/10">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-bg-grid-dark/30 to-transparent" />
                ...
                <div className="group relative h-full">
                  ...
                  {i < steps.length - 1 && (
                    <div className="hidden md:block absolute top-1/2 -right-4 w-8 h-px z-20">
                      <div className="w-full h-full bg-gradient-to-r from-neon-pink/40 via-neon-cyan/40 to-transparent" />
                    </div>
                  )}

                  <div className="relative rounded-2xl border border-neon-cyan/20 bg-void/50 backdrop-blur-sm p-8 md:p-10 h-full transition-all duration-500 group-hover:bg-void/80 group-hover:border-neon-pink/30 neon-box-cyan overflow-hidden">
                    {/* Step number background */}
                    <div className="absolute -top-4 -right-4 text-[120px] font-black leading-none text-neon-pink/[0.03] select-none group-hover:text-neon-pink/[0.08] transition-colors duration-500 font-pixel">
                      {item.step}
                    </div>
                    ...
                    <div className="relative">
                      ...
                      <div className="flex items-center gap-3 mb-6">
                        <div className="flex items-center justify-center h-10 w-10 rounded-xl bg-neon-pink/10 border border-neon-pink/20">
          ...
          <FadeInWhenVisible>
            <div className="text-center mb-20">
              <div className="inline-flex items-center gap-2 rounded-full border border-neon-purple/20 bg-void/50 px-4 py-1.5 mb-6">
                ...
                <span className="text-xs font-medium text-neon-purple/60 uppercase tracking-wider font-pixel">
                  Technology
                </span>
              </div>
              <h2 className="text-4xl font-bold sm:text-5xl lg:text-6xl tracking-tight font-orbitron">
            ...
            <FadeInWhenVisible delay={0.1}>
              <div className="retro-window overflow-hidden">
                ...
                <div className="retro-window-title flex items-center gap-2 px-5 py-3">
                  ...
                  <span className="text-xs text-white font-mono ml-2 font-pixel">deploy-agent.ts</span>
                </div>
                {/* Code content */}
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 mt-10">
              {techStack.map((tech, i) => (
                <ScaleInWhenVisible key={tech.name} delay={0.3 + i * 0.05}>
                  <div className="flex items-center gap-2 rounded-full border border-neon-cyan/30 bg-void/50 backdrop-blur-sm px-4 py-2 hover:border-neon-pink/40 hover:bg-void/80 transition-all cursor-default">
        ...
        <div className="container">
          <FadeInWhenVisible>
            <div className="relative overflow-hidden rounded-3xl cta-animated-bg p-1">
              <div className="relative rounded-[calc(1.5rem-4px)] bg-background/[0.03] backdrop-blur-sm p-12 md:p-20 text-center overflow-hidden vhs-noise">
                {/* Background glow */}
                ...
                <div className="relative z-10">
                  ...
                  >
                    <Rocket className="h-8 w-8 text-neon-cyan animate-neon-pulse" />
                  </motion.div>
                  ...
                  <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                    <Link
                      href="/dashboard/deploy"
                      className="group inline-flex items-center justify-center rounded-xl text-base font-semibold bg-white text-void px-8 py-4 hover:bg-white/90 transition-all shadow-xl shadow-black/20"
                    >
                      Get Started Now
                  ...
                  <p className="mt-8 text-[9px] text-white/40 font-pixel">
      ...
      {/* ─── Footer ─────────────────────────────── */}
      <footer className="border-t border-neon-cyan/10 bg-void">
        <div className="container py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
            {/* Brand */}
            <div className="md:col-span-2">
              <div className="flex items-center gap-2.5 mb-4">
                <div className="h-8 w-8 rounded-lg bg-neon-pink flex items-center justify-center neon-box-pink">
                  <span className="text-void font-bold text-sm font-orbitron">OC</span>
                </div>
                <span className="text-lg font-bold text-neon-cyan font-orbitron">
                  OpenClaw
              ...
              <p className="text-[8px] text-neon-purple/30 mt-2 font-pixel">分散型AIエージェント</p>
              <div className="flex items-center gap-3 mt-6">
                <a href="#" className="h-9 w-9 rounded-lg border border-neon-cyan/20 bg-void/50 flex items-center justify-center hover:border-neon-cyan/40 hover:bg-void transition-all">
                  <Globe className="h-4 w-4 text-neon-cyan/40" />
                </a>
                <a href="#" className="h-9 w-9 rounded-lg border border-neon-cyan/20 bg-void/50 flex items-center justify-center hover:border-neon-cyan/40 hover:bg-void transition-all">
                  <Terminal className="h-4 w-4 text-neon-cyan/40" />
                </a>
              </div>
            </div>
            ...
            {/* Links */}
            <div>
              <h4 className="text-sm font-semibold mb-4 text-neon-cyan">Product</h4>
              <ul className="space-y-3">
                <li><Link href="/dashboard/deploy" className="text-sm text-neon-cyan/40 hover:text-neon-cyan transition-colors">Deploy Agent</Link></li>
                <li><Link href="/dashboard" className="text-sm text-neon-cyan/40 hover:text-neon-cyan transition-colors">Dashboard</Link></li>
                <li><Link href="/dashboard/revenue" className="text-sm text-neon-cyan/40 hover:text-neon-cyan transition-colors">Revenue</Link></li>
                <li><Link href="/dashboard/skills" className="text-sm text-neon-cyan/40 hover:text-neon-cyan transition-colors">Skills Library</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-sm text-neon-cyan/40 hover:text-neon-cyan transition-colors">Documentation</a></li>
                <li><a href="#" className="text-sm text-neon-cyan/40 hover:text-neon-cyan transition-colors">GitHub</a></li>
                <li><a href="#" className="text-sm text-neon-cyan/40 hover:text-neon-cyan transition-colors">Farcaster</a></li>
                <li><a href="#" className="text-sm text-neon-cyan/40 hover:text-neon-cyan transition-colors">Base</a></li>
              </ul>
            </div>
          </div>

          {/* Bottom bar */}
          <div className="mt-16 pt-8 border-t border-neon-cyan/10 flex flex-col md:flex-row items-center justify-between gap-4">
